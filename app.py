...
import os
from flask import Flask, flash, request, redirect, url_for, send_from_directory, render_template,send_file # type: ignore
...
def decode1():
    image1 = Image.open(UPLOAD_FOLDER+'download.jpg')
    msg1= decrypt(image1)
    return render_template('decodepage.html',msg=msg1)
